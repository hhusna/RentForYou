    ...
    <div class="admin-wrapper">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="/RentForYou/admin/controller/dashboard_controller.php" class="<?php if($active_menu == 'dashboard') echo 'active'; ?>">Dashboard</a>
                <a href="/RentForYou/admin/controller/kelola_motor_controller.php" class="<?php if($active_menu == 'kelola_motor') echo 'active'; ?>">Kelola Motor</a>
                <a href="/RentForYou/admin/controller/kelola_transaksi_controller.php" class="<?php if($active_menu == 'kelola_transaksi') echo 'active'; ?>">Kelola Transaksi</a>
            </nav>
        </aside>
        <main class="main-content">
            <header class="main-header">
                ...
                <div class="admin-user-menu">
                    ...
                    <a href="/RentForYou/controller/logout_controller.php" class="admin-logout-btn" title="Logout">
